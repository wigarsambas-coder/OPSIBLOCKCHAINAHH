...
# Blockchain dimuat SELALU (bukan cuma untuk admin) — soalnya tab Verifikasi
# yang publik juga butuh baca ledger ini untuk mencocokkan gambar suspek.
blockchain = get_blockchain()

# is_admin: true HANYA kalau sudah login DAN emailnya ada di admin_emails (Secrets).
# Siapa pun yang belum login, atau login tapi emailnya gak terdaftar, dianggap
# pengunjung biasa (is_admin=False) — bukan diblokir total dari app.
...
# Tab Registrasi & Kelola Ledger CUMA muncul untuk admin. Pengunjung biasa/
# belum login cuma lihat 1 tab: Verifikasi.
if is_admin:
...
# =========================================================================
# TAB VERIFIKASI — TERBUKA UNTUK SEMUA ORANG, gak perlu login
# =========================================================================
with tab_verifikasi:
...
# =========================================================================
# TAB KELOLA LEDGER (admin only): lihat semua entri & hapus (soft delete)
# =========================================================================
if is_admin:
    with tab_kelola:
